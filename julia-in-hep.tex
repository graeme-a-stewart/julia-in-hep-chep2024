...
level suitable for analysis (DSTs, NTuples, AODs), the path to publication
diverges into many individual and group physics analyses. For this stage, as
...
Strube~\cite{Stanitzki:2020bnx}. It is notable that statistical tools are well
...
Section~\ref{sec:hepdataformats}), which is straight forward with
\texttt{UnROOT.jl}~\cite{Gal_UnROOT_an_I_O_2021}. Then there is a growing
