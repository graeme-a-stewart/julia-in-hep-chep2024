...
implicit types (line 3) and explicit loop (line 5) and branch constructs (line
6), implicit loops via ``comprehensions'' (line 14) to generate a  value for
every point in an implicitly defined array, and, finally, transparent
broadcasting of operations over that array (line 15, where both the function call to
