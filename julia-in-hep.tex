...
Array based calculations are trivial to execute on the GPU. The listings in Figure~\ref{code:arraysgpu} an array is copied to the GPU and then executes a simple operation. 
